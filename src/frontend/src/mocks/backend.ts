...
export const mockBackend: backendInterface = {
  ...
  requestAccess: async () => ({ ok: null } as any),
  isInitialized: async () => true,
  listPendingUsers: async () => [],
  listApprovedUsers: async () => [],
  approveUser: async () => ({ ok: null } as any),
  rejectUser: async () => ({ ok: null } as any),
  deactivateUser: async () => ({ ok: null } as any),
  activateUser: async () => ({ ok: null } as any),
